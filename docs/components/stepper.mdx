...
# <h1 style={{ fontSize: "3rem" }}>Stepper</h1>

<div style={{ maxWidth: '60%' }}>

Componente utilizado para indicar o progresso através de etapas numeradas.
...
Como o **label** possui uma largura máxima (`15em`), ao atingir esse tamanho o texto é truncado (inclui reticencias) e exibe-o por completo através do componente [`tooltip`](./tooltip.mdx) ao colocar o cursor sobre o texto.
...
Ao atingir este limite, o texto é truncado (inclui reticencias) e também exibe-o por completo com o [`tooltip`](./tooltip.mdx) ao colocar o cursor sobre o texto.
