...
O componente `menu` tem como objetivo viabilizar a navegação e orientar a pessoa usuária dentro de uma interface.
...
<img src={MenuVariations} alt="Menu base" />
