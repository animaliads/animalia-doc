...
3. **Info bar:** texto e valor percentual ou mensagem de erro (dependendo dos [**estados**](#estados) do componente),
...
> A estrutura do **upload content** pode variar de acordo com o estado do componente `file uploader`. Saiba mais na [**seção de estados**](#estados).
