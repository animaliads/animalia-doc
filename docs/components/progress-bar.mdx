...
1. **Bar indicator:** é a forma que preenche a barra conforme o carregamento ocorre, de maneira [determinada ou indeterminada](#comportamento);
...
> O estado de **error** modifica a **infor bar**, passando a exibir um ícone de exclamação seguido por uma mensagem de erro. [Saiba mais em Estados](#estados)
...
> No modo [**single**](#modo-single), o componente continua respeitando a composição básica, ou seja, sem a **info bar**.
