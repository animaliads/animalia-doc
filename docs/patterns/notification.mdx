...
Quando falamos de notificações que interrompem o fluxo da pessoa usuária, temos a [`modal`](../components/modal.mdx) como
...
Quando falamos de notificações que não interrompem a pessoa usuária, temos o [`toaster`](../components/toaster.mdx) como principal
